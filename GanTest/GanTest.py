...
class GAN():
    ...
    def train(self, epochs=30000, batch_size=128, save_interval=1000):

        print('Load Start')
        # mnistデータの読み込み
        #print('train_images.shape[0] = ' + str(train_images.shape[0]))
    ...
    def sample_images(self, epoch):
        ...
        plt.savefig(os.path.join(save_dir, '{}.png'.format(epoch)))
